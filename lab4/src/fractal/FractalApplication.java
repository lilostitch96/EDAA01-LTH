...
public class FractalApplication extends Application {
	...
	final double fractalWidth = 1300;
	final double fractalHeight = 550;
	...
	public void start(Stage stage) {
		...
		fractals[0] = new TreeFractal(100, 10);
		fractals[1] = new Koch(300);	
		fractals[2] = new Mountain(new Point(50,400), new Point(700,50), new Point(1100,500),70);	
